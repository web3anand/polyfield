...
export default function Leaderboard() {
  ...
  // Step 1: Fetch wallets for all users via search API (username -> search API -> wallet)
  ...
  return (
    <div className="min-h-screen bg-background pt-12 md:pt-16">
      <div className="container mx-auto px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-8 max-w-7xl">
        {/* Sleek & Elegant Header */}
        <div className="mb-6 md:mb-10">
          <div className="flex flex-col gap-4 md:gap-6">
            {/* Title Section */}
            <div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-1 md:mb-2">
                Leaderboard
              </h1>
              <p className="text-muted-foreground text-xs sm:text-sm md:text-base font-normal">
                {isUsersPage
            ...
            <div className="w-full space-y-2 md:space-y-3">
              ...
              <div className="relative">
                <Search className="absolute left-3 md:left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5 md:w-4 md:h-4 text-muted-foreground z-10" />
                <Input
                  type="text"
                  placeholder={isUsersPage ? "Search users..." : "Search builders..."}
                  value={searchQuery}
                  onChange={(e) => handleSearchChange(e.target.value)}
                  className="pl-9 md:pl-11 pr-3 md:pr-4 h-9 md:h-11 text-xs md:text-sm bg-background/50 backdrop-blur-sm border-border/50"
                />
              </div>
              ...
              {isUsersPage && (
                <div className="flex flex-wrap gap-1.5 md:gap-2">
                  <Select value={pnlFilter} onValueChange={handlePnlFilterChange}>
                    <SelectTrigger className="w-[110px] sm:w-[130px] md:w-[140px] h-8 md:h-10 text-xs md:text-sm bg-background/50 backdrop-blur-sm border-border/50">
                      <Filter className="w-3 h-3 md:w-4 md:h-4 mr-1.5 md:mr-2 flex-shrink-0" />
                  ...
                  <Select value={sortBy} onValueChange={handleSortChange}>
                    <SelectTrigger className="w-[110px] sm:w-[130px] md:w-[140px] h-8 md:h-10 text-xs md:text-sm bg-background/50 backdrop-blur-sm border-border/50">
                      <ArrowUpDown className="w-3 h-3 md:w-4 md:h-4 mr-1.5 md:mr-2 flex-shrink-0" />
                  ...
                  <Select value={sortOrder} onValueChange={handleSortOrderChange}>
                    <SelectTrigger className="w-[100px] sm:w-[110px] md:w-[120px] h-8 md:h-10 text-xs md:text-sm bg-background/50 backdrop-blur-sm border-border/50">
                                  ...
                                  return (
                                    ...
                                    >
                                      <td className="py-2 px-3">
                                        <span
                                          className={`font-black text-sm ${isTopThree ? "text-foreground" : "text-muted-foreground"}`}
                                          style={{ imageRendering: "pixelated" }}
                                        >
                                          [{rankNum}]
                                        </span>
